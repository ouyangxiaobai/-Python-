  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" label="评级" prop="pingji">
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="教师评语" prop="jiaoshipingyu">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.jiaoshipingyu" label="教师评语" prop="jiaoshipingyu">
                    <span>{{ruleForm.jiaoshipingyu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
